        ...
        <div className="row cfluid">
          <div className="col-10">
            <div className="subHeader">
              <a className="nav-link active clg" aria-current="page" href="viewPolicy.html">View policy</a>
              <a className="nav-link active clg" aria-current="page" href="profile1.html">Profile </a>
              <a className="nav-link active clg" aria-current="page" href="mypolicy.html">My Policy</a>
            </div>
          </div>
          <div className="col-2">
            <div className="container logoutBtn ">
              <a className="navbar-brand" href="#1">logout</a>
              <a className="navbar-brand" href="addpolicy.html">Admin</a>
            </div>
          </div>
        </div>
        <div className="row policy_info">
          <div className="col-10 rowctn1">
          ...
          <div className="col-2 rowctn2">
            <div className="container starStyle ">
